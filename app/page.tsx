...
let integrations = [
	{
		title: "Figma",
		desc: "Ut enim ad minim veniam Sign in with your UIC 🥲🙌😍😭🎉👏😇😭🎉🎉🎉🎉email to share your love to your teacher! Sign in with your UIC email to share your love to your teacher!",
		icon: () => (
			<svg
				className="w-10 h-10"
				viewBox="0 0 43 48"
	...
	{
		title: "Github",
		desc: "Ut enim ad minim veniam Ut enim ad minim veniam Sign in with your UIC 🥲🙌😍😭🎉👏😇😭🎉🎉🎉🎉email to share your love to your teacher! Sign in with your UIC email to share your love to your teacher!",
		icon: () => (
			<svg
				className="w-10 h-10"
				viewBox="0 0 48 48"
		...
		<>
			<div className="isolate bg-white">
				...
				<div className="relative">
					...
					<div
						className="absolute inset-x-0 -z-10 flex transform-gpu overflow-hidden pt-8 opacity-25 blur-[75px] xl:justify-end -scale-y-100"
						aria-hidden="true"
					>
						<div
